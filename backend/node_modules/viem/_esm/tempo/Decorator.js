    ...
    return (client) => {
        return {
            ...
            channel: {
                ...
                requestClose: (parameters) => channelActions.requestClose(client, parameters),
                requestCloseSync: (parameters) => channelActions.requestCloseSync(client, parameters),
                settle: (parameters) => channelActions.settle(client, parameters),
                settleSync: (parameters) => channelActions.settleSync(client, parameters),
                signVoucher: (parameters) => channelActions.signVoucher(client, parameters),
                ...
                withdrawSync: (parameters) => channelActions.withdrawSync(client, parameters),
            },
            dex: {
            ...
            fee: {
                validateToken: (parameters) => feeActions.validateToken(client, parameters),
                // @ts-expect-error
