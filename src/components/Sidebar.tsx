  ...
  return (
    <>
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-[60] w-10 h-10 bg-arc-dark neo-border rounded-lg flex items-center justify-center text-white"
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 bg-black/50 z-[70]" onClick={() => setMobileOpen(false)} />
      )}

      <aside
        className={`fixed top-0 left-0 bottom-0 w-64 bg-arc-dark border-r-2 border-arc-black flex flex-col z-[80] transition-transform duration-300 ${
