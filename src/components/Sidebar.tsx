      ...
      <header className="fixed top-0 left-0 right-0 z-[90] h-14 bg-arc-dark border-b-2 border-arc-black flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-arc-green rounded-md flex items-center justify-center">
            ...
            <span className="font-black text-sm text-white hidden sm:inline">ARC<span className="text-arc-green">Pay</span></span>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/"
            className="text-xs text-gray-500 hover:text-gray-300 transition-colors hidden sm:flex items-center gap-1 mr-2"
          >
